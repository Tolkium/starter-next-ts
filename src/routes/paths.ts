...
const MOCK_ID = 1;
const MOCK_TITLE = 'Exploring the Impact of Artificial Intelligence on Modern Healthcare';
...
export const paths = {
  ...
  post: {
    ...
    demo: { details: `/post/Exploring the Impact of Artificial Intelligence on Modern Healthcare` },
  },
  // AUTH
  auth: {
    amplify: {
